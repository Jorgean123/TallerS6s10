...
<div class="row g-4"><div class="col-lg-8"><div class="card p-4"><div class="table-responsive"><table class="table align-middle"><caption>Pesos de evaluación: 20%, 30% y 50%.</caption><thead><tr><th scope="col">Evaluación</th><th scope="col">Nota</th><th scope="col">Peso</th><th scope="col">Aporte</th></tr></thead><tbody>
...
</tbody></table></div></div></div><div class="col-lg-4"><section class="result-card"><span class="eyebrow">PROMEDIO FINAL</span><div class="result-number">${promedio}</div><p class="text-secondary">sobre 20 puntos</p>
